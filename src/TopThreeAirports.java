...
public class TopThreeAirports {
    ...
    public static void main(String[] args) throws Exception {
        ...
        filtflights = ((DataSource<Tuple2<String,String>>) flights).setParallelism(1).filter(new FilterFunction<Tuple2<String, String>>(){
            @Override
        ...
        .writeAsCsv("/home/storm/data3404/assignment_data_files/t1output_medium.csv", "\n", "\t", FileSystem.WriteMode.OVERWRITE);
        filtflights.print();
